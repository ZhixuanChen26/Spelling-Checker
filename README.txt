...
5. **Javadoc Documentation**: For the Javadoc comments created for the project, see them in each class's code (test classes don't have Javadoc comments), or browse on a website by clicking **index.html** in the `2212projJavadoc` folder.
